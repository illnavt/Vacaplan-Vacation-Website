...
if (isset($_POST['data'])) {
    ...
    if ($jalur == 'Darat') {
        $table = 'jalur_darat';
        $sql = "INSERT INTO $table (nama_transportasi, gambar, provinsi, kota_tujuan, harga) VALUES (?, ?, ?, ?, ?)";
    } elseif ($jalur == 'Air') {
        $table = 'jalur_air';
        $sql = "INSERT INTO $table (nama_transportasi, gambar, provinsi, kota_tujuan, harga) VALUES (?, ?, ?, ?, ?)";
    } elseif ($jalur == 'Udara') {
        $table = 'penerbangan';
        $sql = "INSERT INTO $table (nama_maskapai, gambar, provinsi, kota_tujuan, harga) VALUES (?, ?, ?, ?, ?)";
    } else {
        echo "Error: Jalur tidak valid";
        exit();
    }

    // Using prepared statements to prevent SQL injection
    $stmt = $koneksi->prepare($sql);
    $stmt->bind_param("sssss", $nama_transport, $link, $provinsi, $kota, $harga);
                        ...
                        <div class="nav__dropdown">
                            ...
                            <div class="nav__dropdown-collapse">
                                <div class="nav__dropdown-content">
                                    <a href="" class="nav__dropdown-item active">Transport</a>
                ...
                <form action="" method="POST">
                    <div class="gradient-border" id="box">
                        <table style="width:100%; font-size: 18px;">
                            <tr>
                                <th style="width: 28%;">Nama Transport</th>
                                <td><input type="text" name="nama_transport" required autocomplete="off"></td>
                            </tr>
                            <tr>
                                <th>Link Foto</th>
                            ...
                            <tr>
                                <th>Kota</th>
                                <td><input type="text" name="kota_tujuan" required autocomplete="off"></td>
                            </tr>
                            <tr>
                                <th>Jalur</th>
                                <td>
                                    <select name="jalur" required>
                                        <option align="center" selected disabled>--- JALUR ---</option>
