...
if (isset($_POST['data'])) {
    ...
    $stmt = $koneksi->prepare("INSERT INTO tempat_wisata (nama_wisata, gambar, provinsi, kota, harga) VALUES (?, ?, ?, ?, ?)");
    $stmt->bind_param("sssss", $nama_wisata, $link, $provinsi, $kota, $harga);
                        ...
                        <div class="nav__dropdown">
                            ...
                            <div class="nav__dropdown-collapse">
                                <div class="nav__dropdown-content">
                                    ...
                                    <a href="" class="nav__dropdown-item active">Wisata</a>
                ...
                <form action="" method="POST">
                    <div class="gradient-border" id="box">
                        <table style="width:100%; font-size: 18px;">
                            <tr>
                                <th style="width: 28%;">Nama Wisata</th>
                                <td><input type="text" name="nama_wisata" required autocomplete="off"></td>
                            </tr>
                            <tr>
                                <th>Link Foto</th>
